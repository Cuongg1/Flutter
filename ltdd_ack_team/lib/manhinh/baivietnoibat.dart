...
class BaiVietNoiBat extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return BaiVietNoiBatState();
  }
}

class BaiVietNoiBatState extends State<BaiVietNoiBat> {
  String EMAIL = '';
  ...
  void _Loadlbaiviet() async {
    final data = await BaivietNoiBatProvider.getbvnbAll();
